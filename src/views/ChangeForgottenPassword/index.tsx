...
const ChangePassword = () => {
  ...
  const handleChangeForgottenPassword: SubmitHandler<IFormData> = async formData => {
    try {
      ...
      await api.put('/password-forgot', { password: formData.password, urlToken: token })
  ...
  return (
    <Container>
      <Header />
      <main>
        <Form onSubmit={handleChangeForgottenPassword} ref={formRef}>
          <Input name='password' type='password' label='Insira sua nova senha:' />
